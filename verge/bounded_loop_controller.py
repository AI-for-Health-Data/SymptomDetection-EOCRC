...
def build_refined_claim(
    ...
    return {
        ...
        # Keep original Agent 1 provenance rather than pretending that
        # Refiner evidence was an Extractor inference.
...
def run(args: argparse.Namespace) -> None:
    ...
    for note_number, run_idx in enumerate(
        ...
        for feature in SYMPTOMS:
            ...
            # Agent 5 receives no clinical note.
            try:
                ...
                # Fail safely to final loop claim and force review.
                fallback_label = str(
                    loop_info.get(
                        "final_claim",
                        original_claim,
            ...
            # Defensive sticky review enforcement at controller level.
            if (
                safe_bool(
